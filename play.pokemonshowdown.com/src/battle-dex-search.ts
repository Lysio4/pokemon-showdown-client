...
class BattleMoveSearch extends BattleTypedSearch<'move'> {
	...
	static readonly GOOD_WEAK_MOVES = [
		'accelerock', 'acrobatics', 'aquacutter', 'avalanche', 'barbbarrage', 'bonemerang', 'brainblast', 'bouncybubble', 'bulletpunch', 'buzzybuzz', 'ceaselessedge', 'circlethrow', 'clearsmog', 'cruelfeather', 'doubleironbash', 'dragondarts', 'dragontail', 'drainingkiss', 'endeavor', 'facade', 'firefang', 'flamingsphere', 'flipturn', 'flowertrick', 'freezedry', 'frustration', 'futuredoom', 'geargrind', 'gigadrain', 'goodfishing', 'grassknot', 'gyroball', 'houndshowl', 'icefang', 'iceshard', 'iciclespear', 'infernalparade', 'intrepidcrash', 'knockoff', 'landslide', 'lastrespects', 'lowkick', 'machpunch', 'mortalspin', 'mysticalpower', 'naturesmadness', 'nightshade', 'nuzzle', 'pikapapow', 'poisonwhip', 'populationbomb', 'psychocut', 'psyshieldbash', 'pursuit', 'quickattack', 'ragefist', 'rapidspin', 'return', 'rockblast', 'roguewave', 'ruination', 'saltcure', 'scorchingsands', 'seismictoss', 'shadowclaw', 'shadowsneak', 'sizzlyslide', 'sneakyassault', 'sonicboom', 'stoneaxe', 'stonesurge', 'storedpower', 'stormthrow', 'suckerpunch', 'superfang', 'surgingstrikes', 'sweetheart', 'tachyoncutter', 'tailslap', 'thunderclap', 'tripleaxel', 'tripledive', 'twinbeam', 'uturn', 'vacuumwave', 'veeveevolley', 'voltswitch', 'watershuriken', 'weatherball',
	] as ID[] as readonly ID[];
